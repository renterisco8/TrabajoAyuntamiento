...
/* CAPTURA LOS DATOS ENVIADOS DESDE LOS CAMPOS DE TEXTO */
    ...
    $fechalta_usu=date("Y-m-d", strtotime("today"));
...
/* INSERCIÓN DE LOS DATOS - TODOS LOS VALORES ENTRE COMILLAS
SIMPLES AUNQUE SEAN NUMÉRICOS */
if ($mysqli->query("INSERT INTO usuarios (correo_usu, clave_usu, fechalta_usu, nif_usu, nombre_usu, ape1_usu, ape2_usu, fechnac_usu, lugar_usu, calle_usu, 
    numero_usu, piso_usu, letra_usu, ciudad_usu, codpost_usu, pais_usu, delito_usu, estado_usu)
    VALUES ('$correo_usu', '$clave_usu', '$fechalta_usu', '$nif_usu', '$nombre_usu', '$ape1_usu', '$ape2_usu', '$fechnac_usu', '$lugar_usu', '$calle_usu', 
    '$numero_usu', '$piso_usu', '$letra_usu', '$ciudad_usu', '$codpost_usu', '$pais_usu', '$delito_usu', '$estado_usu')") === TRUE) {
